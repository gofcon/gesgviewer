...
from services.param_hw_service import ParamHwService
from utils.export_utils import export_to_excel
from db.models.auth import AppUser


class ParamHwCalcView(QWidget):
    """HW Calc 파라미터 (테이블 + 차트)"""
    ...
    def _build_ui(self) -> None:
        ...
        btn_search.clicked.connect(lambda: self._load_data(1))
